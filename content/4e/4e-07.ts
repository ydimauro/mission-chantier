...
export const MISSION_4E_07_TRACE = { title: "Organiser les flux", prompt: "Dans ton cahier, trace un plan simple avec accès engins, passage des personnes, stockage et zone interdite. Justifie deux choix." } as const;
