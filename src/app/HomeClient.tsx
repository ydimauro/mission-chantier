...
export function HomeClient() {
  return (
    <div className="mx-auto flex max-w-7xl flex-col gap-3 px-3 py-3 sm:px-5 sm:py-4">
      ...
      <section aria-label="Commencer ou reprendre" className="grid gap-3 lg:grid-cols-[1.45fr_1fr]">
        <div className="rounded-lg border border-border bg-surface p-4 shadow-sm sm:p-5">
          ...
          <Link href="/mission" className="mt-4 inline-flex rounded-full bg-brand px-4 py-2 text-sm font-semibold text-brand-contrast">{HOME_CONTENT.ctaLabel}</Link>
        </div>
      ...
      <p className="text-center text-xs text-ink-muted">La première mission contient l’observation et l’écriture dans ton cahier.</p>
    </div>
  );
}
